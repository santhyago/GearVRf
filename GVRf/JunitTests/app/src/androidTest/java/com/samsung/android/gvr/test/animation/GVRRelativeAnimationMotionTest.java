 ...
 */
public class GVRRelativeAnimationMotionTest extends ActivityInstrumentationGVRf {
    ...
    public void testSetInvalidRepeatModeAnimation() {
        ...
        try {
            ...
            GVRRelativeMotionAnimation animation = new GVRRelativeMotionAnimation(sceneObject,
                    1.0f, 1.0f, 1.0f, 1.0f);
